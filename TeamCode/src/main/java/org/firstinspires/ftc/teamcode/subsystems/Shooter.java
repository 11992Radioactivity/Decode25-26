...
//    );
    ...
    private MotorEx leftMotor = new MotorEx("FlyWheelL").reversed().brakeMode();
    private MotorEx rightMotor = new MotorEx("FlyWheelR").brakeMode();
    ...
    private double kS = 1.0398;
    private double kPdef = 0.03;
    ...
    private final double gate_closed = 0.41;
    ...
    public void periodic() {
        ...
        if (Math.abs(control.getGoal().getVelocity()) < 100) {
            ...
            motors.setPower(target_effort * (12 / volts));
