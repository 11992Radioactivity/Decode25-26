...
@Autonomous(name = "Blue Close 15 Better Auto", preselectTeleOp = "ManualTeleOp")
@Disabled
public class BlueClose15FullClassifierAuto extends NextFTCOpMode {
    public BlueClose15FullClassifierAuto() {
        addComponents(
    ...
    private final boolean INTAKE_GATE_TWICE = false;
    ...
    public void onUpdate() {
        ...
        telemetryM.addData("time", curTime);
